...
import { Eye, EyeOff, Mail, Lock, User, Thermometer } from "lucide-react"
    ...
    <div className="min-h-screen bg-[#0D0D0D] text-white flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-[#1A1A1A] border-gray-800">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-poppins">Join Microclimate Hub</CardTitle>
          <p className="text-gray-400">Create your account to start tracking climate data</p>
        </CardHeader>
        <CardContent>
